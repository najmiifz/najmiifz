...
<head>
  ...
  <style>
    ...
    .content-box { background-color: white; border-radius: 15px; padding: 2rem; box-shadow: 0 5px 20px rgba(0,0,0,0.1); }
    .section-title { font-weight: bold; margin-top: 2rem; margin-bottom: 1rem; }
...
<body>
  ...
  <div class="main-content">
    <div class="content-box">
      ...
      <!-- Gambar -->
      <div class="mt-3">
        <p class="info-label">Foto Barbershop:</p>
        <img src="/uploads/barberganteng.jpg" alt="Foto Barbershop" class="img-fluid rounded" style="max-width: 300px;">
      </div>
