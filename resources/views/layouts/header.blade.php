    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                @guest
                    <li class="nav-item">
                        <a class="nav-link text-gold" href="{{ route('pilih-akun-mitra') }}">Jadi Mitra</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-gold" href="{{ route('login') }}">Login</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('pilih-akun-pelanggan') }}" class="btn btn-gold ms-2">Register</a>
                    </li>
                @endguest
                ...
                @auth
                    @if(Auth::user()->role == 'pelanggan')
                        <li class="nav-item">
                            <a class="nav-link text-gold" href="{{ route('dashboard') }}"><i class="bi bi-house-door me-1"></i>Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-gold" href="{{ route('riwayat-booking') }}"><i class="bi bi-clock-history me-1"></i>Riwayat Booking</a>
                        </li>
                    @endif

                    @if(Auth::user()->role == 'mitra')
                        <li class="nav-item">
                            <a class="nav-link text-gold" href="{{ route('dashboard.mitra') }}"><i class="bi bi-speedometer2 me-1"></i>Dashboard Mitra</a>
                        </li>
                    @endif

                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center text-gold" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
